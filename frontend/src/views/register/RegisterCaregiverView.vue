...
function buildPayload(): CaregiverRegisterPayload {
  return {
...
<template>
  <main class="register-form-page">
    ...
    <section class="form-shell" aria-labelledby="caregiver-register-title">
      <div class="page-heading">
        <h1 id="caregiver-register-title">สมัครบัญชีนักกิจกรรมบำบัด</h1>
      ...
      <form class="register-form" @submit.prevent="submitForm">
        ...
        <fieldset>
          ...
          <label>
            <span>เลขใบประกอบวิชาชีพ <strong class="required-marker">*</strong></span>
            <input v-model="form.license_id" required maxlength="80" />
          </label>
